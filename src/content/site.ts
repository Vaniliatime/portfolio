...
export const services: Service[] = [
  {
    ...
    from: { en: "from €900", pl: "od 3900 zł" },
    bullets: {
  ...
  },
  {
    ...
    body: {
      en: "Something with accounts, data and logic behind it. I have taken one of those from an empty folder to a running server: schema, auth, two-factor, email, dashboards and deployment.",
      pl: "Coś z kontami, danymi i logiką w tle. Jedną taką doprowadziłem od pustego katalogu po działający serwer: schemat bazy, logowanie, 2FA, maile, panele i wdrożenie.",
    },
    from: { en: "from €3500", pl: "od 15 000 zł" },
    bullets: {
  ...
  },
  {
    ...
    from: { en: "from €45 a month", pl: "od 199 zł miesięcznie" },
    bullets: {
